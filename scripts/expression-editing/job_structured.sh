...
#SBATCH --gres=gpu:tesla:1  # Number of GPUs required
#SBATCH --mem=10GB  # Memory per node
#SBATCH --time=08:00  # Time limit (hours:minutes:seconds)
...
python3 structured_noise.py --model "$1" --prompt "$2" --image_path "$3"
